    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="outline" size="icon" className="w-14 h-14 rounded-full border-2 border-slate-100 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 transition-all">
                    <Pencil className="w-5 h-5" />
                </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px] rounded-[2rem] border-none shadow-xl p-8 bg-white">
                <DialogHeader className="mb-6">
                    <DialogTitle className="text-3xl font-black">Editar Profissional</DialogTitle>
                ...
                <form action={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="edit-name" name="name" defaultValue={attendant.name} placeholder="Ex: João Silva" className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50 font-bold text-slate-700 focus:border-indigo-500/50" required />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="edit-email" name="email" type="email" defaultValue={attendant.email || ''} placeholder="joao@exemplo.com" className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50 font-bold text-slate-700 focus:border-indigo-500/50" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="edit-phone" name="phone" defaultValue={attendant.phone || ''} placeholder="(11) 99999-9999" className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50 font-bold text-slate-700 focus:border-indigo-500/50" />
                    </div>
